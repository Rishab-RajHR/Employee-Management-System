                              ...
                              <td>
                                 {leave.status === "PENDING" && (
                                    <div className='flex justify-center gap-2'>
                                        ...
                                        >
                                            {processing === (leave._id || leave.id) ? <Loader2 className="w-4 h-4 animate-pulse"/> : <Check className='w-4 h-4'/> }
                                        </button>
                                        <button
                                        ...
                                        >
                                            {processing === (leave._id || leave.id) ? <Loader2 className="w-4 h-4 animate-pulse"/> : <X className='w-4 h-4'/> }
                                        </button>
                                    </div>
                                 )}
                              </td>

...
import { Plus, Search, Slash, X } from 'lucide-react'
       ...
       {showCreateModal && (
          <div className='fixed bg-black/40 backdrop-blur-sm inset-0 z-50 flex items-start justify-center p-4 overflow-y-auto' onClick={()=> setShowCreateModal(false)}>
            ...
            <div className='fixed inset-0'/>
              ...
              <div className="relative bg-white rounded-2xl shadow-2xl max-w-3xl my-8 animate-fade-in" onClick={(e)=> e.stopPropogation()}>

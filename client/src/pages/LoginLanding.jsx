           ...
           <div className='w-full max-w-md animate-fade-in relative z-10'>
            ...
            <div>
               {portalOptions.map((portal) =>(
                   <Link key={portal.to} to={portal.to} className='group block bg-slate-50 border border-slate-200 rounded-lg p-5 sm:p-6 transition-all duration-300 haover:border-indigo-400 hover:bg-indigo-50'>
            ...
            {/* Footer */}
              <div className='mt-12 text-center md:text-left text-sm text-slate-400'>
                 <p>@ {new Date().getFullYear()} AlexHilton. All rights reserved.</p>
              </div>
           </div>
        </div>
    </div>
